...
import { Shield, Clock, Users, AlertCircle, CheckCircle, Lock, Key } from 'lucide-react';
    ...
    <div className="max-w-4xl space-y-6">
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <h2 className="text-gray-900 mb-1">Security & Authentication</h2>
      ...
      <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-200">
          <h3 className="text-gray-900">Multi-Factor Authentication Policy</h3>
          <p className="text-gray-600">Control MFA requirements across your organization</p>
        </div>
